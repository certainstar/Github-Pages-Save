...
> ___注意：若您的5700,5701端口被占用，请使用未被占用的端口进行替换，如何查看哪些端口未被占用，请查看[如何查看端口状态和清理端口工作问题](https://certainstar.github.io/Github-Pages-Save/md/little-Python-software/listening)。
